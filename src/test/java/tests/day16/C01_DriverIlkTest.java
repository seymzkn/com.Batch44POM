...
public class C01_DriverIlkTest {
    ...
    // Driver class'i sayesinde bizim eski driver öldü
    ...
    public void test01(){
        ...
        // driver=new ChromeDriver(); komutundan ötürü yeni bir driver olusturuyor
        // Biz Driver class'dan getDriver'i ilk calistirdigimizda new atamasi olsun
        // sonraki calistirmalarda atama olmasin istiyoruz
        // bunun icin driver=new ChromeDriver(); bu satiri bir if blogu icine alacagiz
        Driver.closeDriver();
